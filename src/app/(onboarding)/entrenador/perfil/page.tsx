    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col items-center gap-3">
        <button
          ...
          className="flex h-24 w-24 items-center justify-center rounded-full border-2 border-dashed border-[#3F3F46] bg-[#18181B] hover:border-[#FF6A1A] transition-colors"
        >
