    ...
    >
      ...
      <span
        className={cn(
          ...
          isToday ? "text-brand-primary" : "text-[#52525B]",
        )}
        aria-hidden
      >
        {domLabel}
      ...
      <div className="relative flex w-full flex-col items-center">
        <button
          ...
          onClick={onClick}
          className={cn(
            "relative w-full rounded-sm transition-all duration-200 focus-visible:outline-2 focus-visible:outline-brand-primary focus-visible:outline-offset-2",
            isSelected ? "ring-1 ring-brand-primary ring-offset-1 ring-offset-[#09090B]" : "",
          )}
          style={{
            height: 48,
            display: "flex",
      ...
      <span
        className={cn(
          ...
          isToday ? "font-bold text-brand-primary" : "text-[#52525B]",
        )}
        aria-hidden
      >
        {dayNum}
    ...
    >
      ...
      <div className="mb-4 flex items-start justify-between gap-3">
        <div className="flex items-center gap-2">
          <Calendar className="h-4 w-4 text-brand-primary" aria-hidden />
          <div>
