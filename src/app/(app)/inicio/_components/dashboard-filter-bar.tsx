      ...
      <div className="flex flex-wrap items-center gap-2">
        ...
        {isDirty && (
          <div className="flex items-center gap-1.5">
            ...
            <span
              className="inline-flex items-center gap-1 rounded-full bg-[#FF6A1A]/15 px-2.5 py-0.5 text-xs font-semibold text-[#FF6A1A]"
              aria-live="polite"
    ...
    <div ref={ref} className="relative">
      <button
        ...
        className={cn(
          ...
          hasSelection
            ? "border-[#FF6A1A]/40 bg-[#FF6A1A]/8 text-[#FF6A1A]"
