  ...
  return (
    <motion.div
      ...
      className={[
        ...
        isDragging ? "shadow-xl shadow-black/50 ring-1 ring-[#FF6A1A]/40" : "",
      ].join(" ")}
    >
      {/* Drag handle */}
      <button
        ...
        {...attributes}
        {...listeners}
        className="mt-1 text-[#3F3F46] hover:text-[#FF6A1A] cursor-grab active:cursor-grabbing min-h-[24px] min-w-[24px] flex items-center transition-colors duration-150"
      ...
      <div className="flex-1 space-y-2.5">
        ...
        <div className="flex items-center gap-2">
          <Dumbbell className="h-3.5 w-3.5 text-[#FF6A1A] shrink-0" aria-hidden="true" />
          ...
          {(
            ...
            <div key={field} className="space-y-0.5">
              ...
              <Input
                type="number"
                inputMode="numeric"
                className="h-7 text-xs px-2 bg-[#09090B] border-[#3F3F46] focus:border-[#FF6A1A]"
          ...
          >
            <div className="p-4 space-y-2">
              ...
              <Button
                ...
                className="w-full gap-2 border-dashed border-[#3F3F46] text-[#71717A] hover:border-[#FF6A1A] hover:text-[#FF6A1A] transition-colors mt-1"
              >
...
function ExerciseSearchPanel({
  ...
  return (
    <motion.div
      ...
      transition={{ duration: 0.18 }}
      className="rounded-xl border border-[#FF6A1A]/30 bg-[#18181B] p-4 space-y-3 shadow-lg shadow-black/40"
    >
      {/* Header */}
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2">
          <div className="flex h-7 w-7 items-center justify-center rounded-lg bg-[#FF6A1A]/15">
            <Search className="h-3.5 w-3.5 text-[#FF6A1A]" aria-hidden="true" />
          </div>
      ...
      <div className="relative">
        ...
        <Input
          ...
          autoFocus
          className="pl-9 h-11 bg-[#09090B] border-[#3F3F46] focus:border-[#FF6A1A] text-sm placeholder:text-[#52525B]"
        />
        {searching && (
          <Loader2 className="absolute right-3 top-1/2 -translate-y-1/2 h-4 w-4 text-[#FF6A1A] animate-spin" aria-hidden="true" />
        )}
      </div>
        ...
        {results.map((ex) => {
          ...
          return (
            <button
              ...
              className="w-full text-left rounded-lg border border-[#3F3F46] bg-[#09090B] p-2.5 hover:border-[#FF6A1A] hover:bg-[#FF6A1A]/5 transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-3 group"
            >
              <div className="flex-1 min-w-0">
                <p className="text-sm font-medium text-[#FAFAFA] truncate group-hover:text-[#FF6A1A] transition-colors">
                  {ex.nameEs}
                </p>
              ...
              {isAdding ? (
                <Loader2 className="h-4 w-4 text-[#FF6A1A] animate-spin shrink-0" aria-hidden="true" />
              ) : (
                <Plus className="h-4 w-4 text-[#52525B] group-hover:text-[#FF6A1A] transition-colors shrink-0" aria-hidden="true" />
              )}
            </button>
          );
        })}
  ...
  return (
    <div className="rounded-xl border border-[#3F3F46] bg-[#18181B] p-4 space-y-4">
      ...
      <div className="flex items-center gap-2 pb-1 border-b border-[#27272A]">
        <div className="flex h-6 w-6 items-center justify-center rounded-md bg-[#FF6A1A]/15">
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel className="text-xs text-[#A1A1AA] uppercase tracking-wide flex items-center gap-1.5">
                  <Calendar className="h-3 w-3 text-[#FF6A1A]" aria-hidden="true" />
                  Días/semana
                </FormLabel>
                <FormControl>
                  <div className="relative">
                    <Input
                      ...
                      min={1}
                      max={7}
                      className="bg-[#09090B] border-[#3F3F46] focus:border-[#FF6A1A] h-11 text-sm pr-12"
                      {...field}
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel className="text-xs text-[#A1A1AA] uppercase tracking-wide flex items-center gap-1.5">
                  <Clock className="h-3 w-3 text-[#FF6A1A]" aria-hidden="true" />
                  Duración
                </FormLabel>
                <FormControl>
                  <div className="relative">
                    <Input
                      ...
                      min={1}
                      max={52}
                      className="bg-[#09090B] border-[#3F3F46] focus:border-[#FF6A1A] h-11 text-sm pr-16"
                      {...field}
                      onChange={(e) => field.onChange(Number(e.target.value))}
                    />
                    <span className="absolute right-3 top-1/2 -translate-y-1/2 text-xs text-[#52525B]">
    ...
    <div className="space-y-5">
      ...
      {(store.days.length > 0 || totalExercises > 0) && (
        <div className="flex flex-wrap gap-2 px-1">
          {[
            ...
            >
              <Icon className="h-3 w-3 text-[#FF6A1A]" aria-hidden="true" />
              {label}
            </span>
          ))}
        </div>
      ...
      <div className="space-y-3">
        ...
        <Button
          ...
          className="w-full gap-2 border-dashed border-[#3F3F46] text-[#71717A] hover:border-[#FF6A1A] hover:text-[#FF6A1A] transition-colors h-11 disabled:opacity-50"
        >
          {addingDay
            ? <Loader2 className="h-4 w-4 animate-spin" aria-hidden="true" />
