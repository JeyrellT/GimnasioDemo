      ...
      <div className="w-full max-w-md">
        ...
        <div className="rounded-2xl border border-[#3F3F46] bg-[#18181B] p-8 shadow-2xl">
          ...
          <div className="mb-6 flex justify-center">
            <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-brand-primary/15">
              <Dumbbell className="h-7 w-7 text-brand-primary" aria-hidden="true" />
            </div>
          </div>
          ...
          <div className="mb-8 space-y-2 text-center">
            <h1 className="text-2xl font-bold text-[#FAFAFA]">
              ¡Bienvenido a{" "}
              <span className="text-brand-primary">Blackline Fitness</span>!
            </h1>
          ...
          <form onSubmit={handleSubmit(onSubmit)} noValidate className="space-y-5">
            ...
            <div className="space-y-1.5">
              <label
                ...
                className="block text-sm font-medium text-[#FAFAFA]"
              >
                Nueva contraseña <span className="text-brand-primary">*</span>
              </label>
            ...
            <div className="space-y-1.5">
              <label
                ...
                className="block text-sm font-medium text-[#FAFAFA]"
              >
                Confirmá la contraseña <span className="text-brand-primary">*</span>
              </label>
              <div className="relative">
                <input
