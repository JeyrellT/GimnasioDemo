...
const consents = [
  {
    ...
    description:
      "Aceptás los Términos y Condiciones y la Política de Privacidad de Forja como proveedor de servicios profesional.",
    required: true,
  },
  {
    ...
    description:
      "Como entrenador, sos procesador de datos sensibles de tus clientes bajo la Ley 8968. Aceptás las obligaciones correspondientes y el uso de Forja como plataforma para ese tratamiento.",
    required: true,
  },
  {
    ...
    description:
      "Recibís emails con novedades de Forja, tips profesionales y anuncios de nuevas funciones.",
    required: false,
  },
];
