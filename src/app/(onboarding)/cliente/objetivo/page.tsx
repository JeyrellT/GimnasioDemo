    ...
    <div className="space-y-6">
          ...
          >
            <div
              className={cn(
                ...
                selected === id ? "bg-[#FF6A1A]/20" : "bg-[#27272A]",
              )}
            >
              <Icon
                className={cn(
                  "h-5 w-5",
                  selected === id ? "text-[#FF6A1A]" : "text-[#A1A1AA]",
                )}
                aria-hidden="true"
              />
            </div>
      ...
      <div className="space-y-1.5">
        ...
        <textarea
          ...
          className="w-full resize-none rounded-lg border border-[#3F3F46] bg-[#27272A] px-3 py-2.5 text-sm text-[#FAFAFA] placeholder-[#71717A] focus-visible:border-[#FF6A1A] focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-[#FF6A1A] transition-colors"
        />
      ...
      <button
        ...
        className="flex w-full items-center justify-center gap-2 rounded-xl bg-[#FF6A1A] py-3.5 text-sm font-semibold text-white min-h-[48px] hover:bg-[#E55A0E] disabled:opacity-50 transition-colors"
      >
