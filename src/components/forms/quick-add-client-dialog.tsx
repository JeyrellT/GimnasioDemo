      ...
      <div className="w-full max-w-sm rounded-xl border border-[#3F3F46] bg-[#18181B] p-5 shadow-2xl">
          ...
          <>
            ...
            >
              ...
              <div className="flex justify-end gap-2 pt-1">
                ...
                <button
                  type="submit"
                  className="flex items-center gap-1.5 rounded-lg bg-[#FF6A1A] px-4 py-2 text-sm font-medium text-white transition-colors hover:bg-[#E55A0E]"
                >
        ...
        {isSubmitting && (
          <div className="flex flex-col items-center justify-center py-8 text-center">
            <div className="mb-4 flex h-14 w-14 items-center justify-center rounded-full bg-[#FF6A1A]/10">
              <Loader2
                className="h-7 w-7 animate-spin text-[#FF6A1A]"
                aria-hidden="true"
              />
            </div>
          ...
          <>
            ...
            <div className="flex flex-col items-center text-center">
              ...
              {success.emailSent ? (
                <>
                  <p className="mb-2 text-sm text-[#FAFAFA]">
                    ...
                    <strong className="text-[#FF6A1A]">{success.email}</strong>
                  </p>
                ...
                <>
                  ...
                  <div className="mb-2 w-full rounded-lg border border-[#3F3F46] bg-[#27272A] p-2.5">
                    <p className="break-all text-left text-[11px] text-[#FF6A1A] font-mono">
                      {success.welcomeUrl}
                    </p>
                  </div>
                  <button
              ...
              <button
                type="button"
                onClick={handleClose}
                className="mt-2 w-full rounded-lg bg-[#FF6A1A] px-4 py-2.5 text-sm font-medium text-white transition-colors hover:bg-[#E55A0E]"
              >
                Listo
              </button>
            </div>
