      ...
      {([1, 2, 3] as const).map((level) => (
        <span
          ...
          className={cn(
            ...
            level <= filled ? "bg-brand-primary" : "bg-[#3F3F46]",
          )}
        />
      ))}
    </span>
  ...
  return (
    <div className="flex items-center gap-0 rounded-xl bg-[#27272A] ring-1 ring-[#3F3F46] overflow-hidden">
      <div className="flex flex-1 flex-col items-center gap-0.5 px-3 py-2.5">
        <RotateCcw className="h-3.5 w-3.5 text-brand-primary" aria-hidden="true" />
      ...
      <div className="flex flex-1 flex-col items-center gap-0.5 px-3 py-2.5">
        <ChevronRight className="h-3.5 w-3.5 text-brand-primary" aria-hidden="true" />
      ...
      <div className="flex flex-1 flex-col items-center gap-0.5 px-3 py-2.5">
        <Timer className="h-3.5 w-3.5 text-brand-primary" aria-hidden="true" />
                    ...
                    <div className="flex flex-col gap-5 px-4 pt-4 pb-6">
                      ...
                      {context?.notes && (
                        <motion.div
                          ...
                          className="flex gap-3 rounded-xl border border-brand-primary/25 bg-brand-primary/5 px-4 py-3"
                        >
                          <StickyNote
