...
export const metadata: Metadata = {
  title: "Precios",
  description:
    "Planes Forja para entrenadores en Costa Rica. Solo ₡8,900, Pro ₡22,900 y Studio ₡44,900 mensuales con IVA incluido.",
};
    ...
    <div className="mx-auto max-w-6xl px-4 py-16">
      ...
      <div className="grid gap-6 sm:grid-cols-3 mb-20">
        {plans.map((plan) => (
          ...
          >
            {plan.highlight && (
              <div className="absolute -top-3 left-1/2 -translate-x-1/2 rounded-full bg-[#FF6A1A] px-3 py-0.5 text-xs font-semibold text-white">
                Más popular
              </div>
            )}
            ...
            <Link
              ...
              className={`mt-6 block rounded-xl py-3 text-center text-sm font-semibold transition-colors min-h-[44px] flex items-center justify-center ${
                plan.highlight
                  ? "bg-[#FF6A1A] text-white hover:bg-[#E55A0E]"
