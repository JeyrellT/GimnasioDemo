// =============================================================================
// BLACKLINE FITNESS — Password reset email template (React Email)
// Owner: backend-api.
//
...
export interface PasswordResetEmailProps {
  url: string;
  /** The email address the reset was requested for (shown in body for clarity) */
  email: string;
...
export default function PasswordResetEmail({
  ...
  return (
    <Html lang="es-CR">
      <Head />
      <Preview>Restablecé tu contraseña de {APP_NAME}</Preview>
        ...
        <Container style={styles.container}>
          ...
          <Section style={styles.content}>
            ...
            <Text style={styles.body_text}>
              Recibimos una solicitud para cambiar la contraseña de la cuenta{" "}
              <strong style={styles.email_highlight}>{email}</strong>.
            </Text>
            <Text style={styles.body_text}>
              Hacé clic en el botón para elegir una nueva contraseña. El enlace
              es válido por <strong>{expiresInMinutes} minutos</strong> y se
            ...
            <Text style={styles.warning}>
              ...
              contraseña actual seguirá funcionando y tu cuenta no fue
              modificada.
            </Text>
          </Section>
