  ...
  return (
    <div className="space-y-6 max-w-lg">
      ...
      <textarea
        ...
        className="w-full resize-y rounded-xl border border-[#3F3F46] bg-[#18181B] px-4 py-3 text-sm text-[#FAFAFA] placeholder-[#71717A] focus-visible:border-[#FF6A1A] focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-[#FF6A1A] transition-colors"
      />
      ...
      <button
        ...
        onClick={handleSave}
        disabled={saving}
        className="rounded-lg bg-[#FF6A1A] px-6 py-2.5 text-sm font-semibold text-white min-h-[44px] hover:bg-[#E55A0E] disabled:opacity-60 transition-colors"
      >
