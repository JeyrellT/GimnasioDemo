          ...
          <div
            ...
            className={cn(
              ...
              isDragging
                ...
                : "border-[#3F3F46] bg-[#18181B] hover:border-brand-primary",
          ...
          {phase.name === "error" && (
            ...
            >
              ...
              <button
                type="button"
                onClick={handleRetry}
                className="shrink-0 text-xs font-semibold text-[#EF4444] underline underline-offset-2 hover:text-[#FCA5A5] focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-brand-primary"
              >
                Reintentar
              </button>
            </div>
