    ...
    <div className={cn("flex flex-col gap-4", className)}>
        ...
        <div className="flex gap-2">
          {geminiReady && (
            <button
              ...
              className="flex-1 inline-flex min-h-[44px] items-center justify-center rounded-xl bg-brand-primary px-4 py-3 text-sm font-semibold text-[#09090B] transition-colors hover:bg-brand-primary-hover focus-visible:outline-2 focus-visible:outline-brand-primary focus-visible:outline-offset-2"
            >
              Detectar datos
            </button>
          )}
          <button
            type="button"
            onClick={handleReset}
            className="inline-flex min-h-[44px] items-center justify-center rounded-xl border border-[#3F3F46] px-4 py-3 text-sm font-semibold text-[#FAFAFA] transition-colors hover:bg-[#27272A] focus-visible:outline-2 focus-visible:outline-brand-primary focus-visible:outline-offset-2"
          >
            Cambiar foto
          </button>
        </div>
      ...
      {state.phase === "extracted" && (
        <button
          ...
          className="inline-flex min-h-[44px] w-full items-center justify-center gap-2 rounded-xl bg-brand-primary px-4 py-3 text-sm font-semibold text-[#09090B] transition-colors hover:bg-brand-primary-hover focus-visible:outline-2 focus-visible:outline-brand-primary focus-visible:outline-offset-2"
        >
          ...
          return (
            <div key={key} className="flex flex-col gap-1">
              ...
              <input
                ...
                className="min-h-[44px] rounded-lg border border-[#3F3F46] bg-[#27272A] px-3 py-2 text-sm text-[#FAFAFA] placeholder:text-[#52525B] focus:border-brand-primary focus:outline-none focus:ring-1 focus:ring-brand-primary"
