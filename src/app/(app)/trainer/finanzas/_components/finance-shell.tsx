      ...
      <div className="flex flex-wrap items-start justify-between gap-3">
        <div className="space-y-0.5">
          <div className="flex items-center gap-2">
            <div className="flex h-7 w-7 items-center justify-center rounded-lg bg-[#FF6A1A]/15">
              <TrendingUp className="h-4 w-4 text-[#FF6A1A]" aria-hidden="true" />
            </div>
            <h1 className="text-xl font-bold capitalize text-[#FAFAFA]">
              Finanzas — <span className="text-[#FF6A1A]">{heading}</span>
            </h1>
          </div>
          {trainerName && (
        ...
        <div className="flex shrink-0 items-center gap-2">
          ...
          <Link
            ...
            className="flex items-center gap-1.5 rounded-lg bg-[#FF6A1A] px-3 py-2 text-sm font-semibold text-white shadow-md shadow-[#FF6A1A]/20 transition-colors duration-150 hover:bg-[#E55D0F]"
          >
