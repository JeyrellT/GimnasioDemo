...
export function getPaletteById(id: string, customHex?: string | null): PalettePreset {
  if (id === "custom" && customHex && HEX_COLOR_REGEX.test(customHex)) {
    return { id: "custom", label: "Custom", ...paletteFromHex(customHex) };
  }
  return (
