    ...
    >
      <Link
        ...
        className={cn(
          ...
          "focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-brand-primary focus-visible:ring-inset",
        )}
        style={
          reduceMotion
            ? undefined
    ...
    >
      ...
      {overflow > 0 && (
        <div className="pt-1 text-center">
          <Link
            href="/trainer/clientes"
            className="text-xs font-medium text-[#71717A] transition-colors hover:text-brand-primary focus-visible:outline-none focus-visible:underline"
          >
