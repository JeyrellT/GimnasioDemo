// =============================================================================
// BLACKLINE FITNESS — Service Worker sync event handler
...
//
// Architecture:
//   SW receives BackgroundSync "blackline-fitness-sync" event
//     → SW posts "BLACKLINE FITNESS_SYNC_REQUEST" to all open clients (tabs)
...
export const SYNC_TAG = "blackline-fitness-sync";

/** Message type broadcast by the SW to open tabs. */
export const SYNC_MESSAGE_TYPE = "BLACKLINE FITNESS_SYNC_REQUEST" as const;

/**
 * Handle a Background Sync event from within the SW context.
 * Posts a message to all open Blackline Fitness clients requesting a sync pass.
