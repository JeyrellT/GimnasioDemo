...
function QuickAction({ href, icon: Icon, label }: QuickActionProps) {
  return (
    <Link
      href={href}
      className="flex items-center gap-2 rounded-full border border-[#3F3F46] bg-[#18181B] px-4 py-2 text-sm font-medium text-[#A1A1AA] transition-all duration-200 hover:border-[#FF6A1A]/40 hover:bg-[#FF6A1A]/8 hover:text-[#FF6A1A] min-h-[36px]"
    >
