  ...
  return (
    <div className="flex min-h-dvh flex-col items-center justify-center gap-6 bg-[#09090B] px-6 text-center">
      ...
      <button
        type="button"
        onClick={reset}
        className="flex items-center gap-2 rounded-lg bg-brand-primary px-6 py-3 text-sm font-semibold text-white min-h-[44px] hover:bg-brand-primary-hover transition-colors"
      >
